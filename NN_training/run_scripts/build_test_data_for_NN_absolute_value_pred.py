import src.ml_io_momentum_no_subsample_memory_eff as ml_io_momentum_no_subsample_memory_eff
import numpy as np
...
flag_dict = dict()
flag_dict['file_num'] = 99

start_time =  1732500 #669150
end_time = 2520000# 2262600

start_time = 360000  + 1000*450 + 2565*450 #9000
end_time = start_time + 450*500
interval = 450
train_size = 1.
n_x_samp = 72
is_cheyenne =True
...
flag_dict['qp_coarse_init'] = False
...
ml_io_momentum_no_subsample_memory_eff.build_training_dataset(training_expt1, start_time, end_time, interval, n_x_samp=n_x_samp, train_size=train_size,
