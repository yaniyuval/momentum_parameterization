...
import src.ml_io_momentum_u_v_unite as ml_io_momentum_u_v_unite
...
flag_dict['T_instead_of_Tabs'] = True
...
flag_dict['sed_level'] = 30
flag_dict['strat_corr_level'] = 48


flag_dict['do_surf_flux_hemispheric_symmetric_correction'] = False
flag_dict['Flux_for_TFULL'] = False

flag_dict['do_uv_surf_fluxes_out'] = True
flag_dict['do_momentum_output'] = True

#flag_dict['adv_u_v_grid'] = True
flag_dict['no_c_grid'] = True
flag_dict['abs_mom_flux'] = True
...
data_specific_description = ml_io_momentum_u_v_unite.create_specific_data_string_desc(flag_dict)
...
input_vert_vars = ['T_instead','qin','u','v','disteq'] #Dependent on the scenario we chose to model. This should give some flexibility to our coding.
output_vert_vars = ['tkz','u_flux_ABS','v_flux_ABS','usf','vsf_7ep']
dim1 = 48
dim2 = dim1-1
...
ml_train_nn.train_wrapper(f_ppi, o_ppi, training_expt1, input_vert_dim, output_vert_dim,
                       ...
                       batch_norm = flag_dict['batch_norm'],neurons=128)
