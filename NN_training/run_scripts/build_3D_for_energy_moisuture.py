import src.ml_io_no_qp_flux_nn_3D as ml_io_no_qp_flux_nn_3D
import numpy as np
...
flag_dict['rad_level'] = 48 #Should be 0 if no radiation should be used in hte RF
...
ml_io_no_qp_flux_nn_3D.build_training_dataset(training_expt1, start_time, end_time, interval, n_x_samp=n_x_samp, train_size=train_size,
                             do_shuffle=do_shuffle, flag_dict =flag_dict,is_cheyenne=is_cheyenne, rewight_outputs=False  )
