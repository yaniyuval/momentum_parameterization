...
flag_dict['resolution'] = 4 #Usually true
...
input_vert_vars = ['T_instead','qin','uug','vug','disteq'] #Dependent on the scenario we chose to model. This should give some flexibility to our coding.
output_vert_vars = ['tkz','u_flux','v_flux','usf','vsf']
dim1 = 48
dim2 = dim1-1
